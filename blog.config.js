...
const BLOG = {
  ...
  NOTION_PAGE_ID:
    ...
    '1d80a24d2d3980cf9d5bce4eceb0d6b5,en:1de0a24d2d398083adaaf66b13396198,de:1df0a24d2d3980bbadfef66bf8873be2',
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'liuqdev', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '能智工人', // 作者简介
  LINK: 'https://liuqdev.github.io' || process.env.NEXT_PUBLIC_LINK, // 网站地址
